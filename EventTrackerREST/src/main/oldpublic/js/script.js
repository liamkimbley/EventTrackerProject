		...
		if (xhr.readyState === 4) {
			if (xhr.status === 200) {
				...
				for (let i = 0; i < data.length; i++) {
					// anything that does anything with the data returned MUST
					// be within this code block!!!!!
				...
				document.getElementById("total").textContent = "Total Spent: $"
						+ total;
...
function editEntry(e) {
	...
	let reas = document.getElementById("editFormID").lastElementChild.previousElementSibling.previousElementSibling.value
